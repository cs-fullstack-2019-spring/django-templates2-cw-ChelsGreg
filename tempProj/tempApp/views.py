...
def home(request):
    print('Home Index')
    return render(request, 'tempApp/movies.html', {'movies': movies})

#FUCNTION FOR details page and info
def movieDetails(request, movie_id):
    print('Movie Details')
    return render(request, 'tempApp/movie_details.html', {'movieD': movies[movie_id]})

#FUNCTION FOR synopsis page and info
def movieSynopsis(request, movie_id):
    print('Movie Synopsis')
    return render(request, 'tempApp/movie_synopsis.html', {'movieS': movies[movie_id]})